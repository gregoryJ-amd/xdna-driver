...
*/
inline int alloc_heap(int fd, __u32 size, __u32 *handle) {
  int ret;
  void *heap_buf = NULL;
...
*/
inline int create_dev_bo(int fd, uint64_t *vaddr, uint64_t *sram_vaddr,
...
*/
inline int sync_bo(int fd, __u32 handle) {
...
inline int load_pdi(int fd, uint64_t *vaddr, uint64_t *sram_addr, __u32 *handle,
                    const char *path) {
...
*/
inline int load_instructions(int fd, uint64_t *vaddr, uint64_t *sram_addr,
